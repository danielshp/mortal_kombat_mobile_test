...
class PulseScr(Screen):
    ...
    def _():
        pass
        line2 = BoxLayout(size_hint = (0.8, None),height = '30sp')
        self.btn = Button(text = "Начать",size_hint = (1, 0.5), pos_hint = {"center-x":0.5})
        self.btn.background_color = btn_color
        #self.btn.on_press = self.go
        self.line3 = BoxLayout(size_hint = (0.8, None),height = '80sp', pos_hint={"center-x":0.5}) 
        outer = BoxLayout(orientation='vertical', padding=8, spacing=8)
        self.line3.add_widget(self.btn)
        self.line3.add_widget(self.btn1)
        self.line3.add_widget(self.btn2)
        self.line3.add_widget(self.btn3)
        self.line3.add_widget(self.btn4)
        outer.add_widget(line1)
